...
<div class="space-y-6">
    <div class="mb-6 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold">Thêm Kho Hàng Mới</h1>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('warehouses.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            <div>
                ...
                <p class="text-gray-500 text-sm">Nhập các thông tin cần thiết cho kho hàng</p>
            </div>
            ...
            <div>
                ...
                <input type="text" name="location" id="address" value="{{ old('address') }}"
