...
class PrintingStyleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.printing_styles.index', compact('printing_styles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.printing_styles.create', compact('printings'));
    }
    ...
    {
        return view('admin.printing_styles.show', compact('printingStyle'));
    }
    ...
    {
        $printings = \App\Models\Printing::all();
        return view('admin.printing_styles.edit', [
